...
class UsersModel(models.Model):
    ...
    email = models.CharField(max_length=128, verbose_name='邮箱', null=True, blank=True, default='')
    phone = models.CharField(max_length=18, verbose_name='电话', null=True, blank=True, default='')
